...
var RuntimeCommandFactory = (function() {
  ...
  RuntimeCommandFactory.prototype._addStyleShimAttributes = function(attrNameAndValues, localComponent, localTemplateId) {
    ...
    if (lang_1.isPresent(localComponent) && localComponent.template.encapsulation === api_1.ViewEncapsulation.Emulated) {
  ...
  RuntimeCommandFactory.prototype.createNgContent = function(ngContentIndex) {
    return template_commands_1.ngContent(ngContentIndex);
  };
