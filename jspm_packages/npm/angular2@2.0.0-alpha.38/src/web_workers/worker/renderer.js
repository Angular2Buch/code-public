...
var WebWorkerRenderer = (function() {
  ...
  WebWorkerRenderer.prototype.registerComponentTemplate = function(templateId, commands, styles) {
    var fnArgs = [new client_message_broker_1.FnArg(templateId, null), new client_message_broker_1.FnArg(commands, api_2.WebWorkerTemplateCmd), new client_message_broker_1.FnArg(styles, null)];
