...
exports.JSONP_BINDINGS = [core_1.bind(http_1.Jsonp).toFactory(function(jsonpBackend, requestOptions) {
  return new http_1.Jsonp(jsonpBackend, requestOptions);
}, [jsonp_backend_1.JSONPBackend, base_request_options_1.RequestOptions]), browser_jsonp_1.BrowserJsonp, core_1.bind(base_request_options_1.RequestOptions).toClass(base_request_options_1.BaseRequestOptions), core_1.bind(base_response_options_1.ResponseOptions).toClass(base_response_options_1.BaseResponseOptions), jsonp_backend_1.JSONPBackend];
