...
export let TemplateNormalizer = class {
    ...
    normalizeLoadedTemplate(directiveType, templateMeta, template, templateAbsUrl) {
        ...
        var allStyleAbsUrls = visitor.styleUrls.map(url => this._urlResolver.resolve(templateAbsUrl, url))
            .concat(templateMeta.styleUrls.map(url => this._urlResolver.resolve(directiveType.moduleUrl, url)));
