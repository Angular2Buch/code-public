...
export let DomRenderer = class {
    ...
    registerComponentTemplate(templateId, commands, styles) {
    ...
    createShadowRoot(host) { return DOM.createShadowRoot(host); }
