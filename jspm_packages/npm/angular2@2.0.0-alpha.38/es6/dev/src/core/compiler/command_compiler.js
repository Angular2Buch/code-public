...
import { isPresent, isBlank, isString } from 'angular2/src/core/facade/lang';
...
class RuntimeCommandFactory {
    ...
    createNgContent(ngContentIndex) { return ngContent(ngContentIndex); }
...
class CodegenCommandFactory {
    ...
    createNgContent(ngContentIndex) {
