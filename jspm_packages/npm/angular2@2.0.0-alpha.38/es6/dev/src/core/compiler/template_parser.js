...
import { RegExpWrapper, isPresent, StringWrapper, isBlank } from 'angular2/src/core/facade/lang';
...
class TemplateParseVisitor {
    ...
    visitElement(element, component) {
        ...
        if (preparsedElement.type === PreparsedElementType.NG_CONTENT) {
            ...
            parsedElement = new EmbeddedTemplateAst(attrs, vars, directives, children, elementNgContentIndex, element.sourceInfo);
        }
        else {
