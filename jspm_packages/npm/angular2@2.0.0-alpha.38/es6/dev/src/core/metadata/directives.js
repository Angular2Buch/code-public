...
import { isPresent, CONST } from 'angular2/src/core/facade/lang';
...
export let DirectiveMetadata = class extends InjectableMetadata {
    constructor({ selector, inputs, outputs, properties, events, host, bindings, exportAs, moduleId, queries } = {}) {
        super();
...
export let ComponentMetadata = class extends DirectiveMetadata {
    constructor({ selector, inputs, outputs, properties, events, host, exportAs, moduleId, bindings, viewBindings, changeDetection = ChangeDetectionStrategy.Default, queries } = {}) {
        super({
            selector: selector,
            inputs: inputs,
            outputs: outputs,
