...
import { isPresent, isBlank, StringWrapper, RegExpWrapper, CONST_EXPR } from 'angular2/src/core/facade/lang';
...
export class UrlParser {
    peekStartsWith(str) { return StringWrapper.startsWith(this._remaining, str); }
    capture(str) {
