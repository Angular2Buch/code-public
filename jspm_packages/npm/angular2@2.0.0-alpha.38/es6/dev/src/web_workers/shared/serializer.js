...
import { RenderProtoViewRef, RenderViewRef, RenderFragmentRef, ViewType, ViewEncapsulation } from "angular2/src/core/render/api";
...
var RENDER_TEMPLATE_CMD_DESERIALIZERS = [
        ...
        (data) => new WebWorkerNgContentCmd(data['ngContentIndex']),
