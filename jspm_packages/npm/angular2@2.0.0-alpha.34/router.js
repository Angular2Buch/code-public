...
exports.routerInjectables = [route_registry_2.RouteRegistry, pipeline_2.Pipeline, di_1.bind(location_strategy_2.LocationStrategy).toClass(html5_location_strategy_2.HTML5LocationStrategy), location_2.Location, di_1.bind(router_2.Router).toFactory(function(registry, pipeline, location, appRoot) {
