...
var location_1 = require("../router/location");
var SpyLocation = (function(_super) {
  ...
  SpyLocation.prototype.noSuchMethod = function(m) {
    _super.prototype.noSuchMethod.call(this, m);
  };
  SpyLocation = __decorate([test_lib_1.proxy(), lang_1.IMPLEMENTS(location_1.Location), __metadata('design:paramtypes', [])], SpyLocation);
  return SpyLocation;
