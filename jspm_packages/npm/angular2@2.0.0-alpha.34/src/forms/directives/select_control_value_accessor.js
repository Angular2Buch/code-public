...
var NgSelectOption = (function() {
  ...
  NgSelectOption = __decorate([annotations_1.Directive({selector: 'option'}), __metadata('design:paramtypes', [])], NgSelectOption);
...
var SelectControlValueAccessor = (function() {
  ...
  SelectControlValueAccessor = __decorate([annotations_1.Directive({
  ...
  }), __param(0, di_1.Self()), __param(3, annotations_1.Query(NgSelectOption, {descendants: true})), __metadata('design:paramtypes', [ng_control_1.NgControl, render_1.Renderer, core_1.ElementRef, core_1.QueryList])], SelectControlValueAccessor);
