...
var NgControlName = (function(_super) {
  ...
  NgControlName = __decorate([annotations_1.Directive({
    selector: '[ng-control]',
    ...
    exportAs: 'form'
  }), __param(0, di_1.Host()), __param(0, di_1.SkipSelf()), __param(1, annotations_1.Query(validators_1.NgValidator)), __metadata('design:paramtypes', [control_container_1.ControlContainer, core_1.QueryList])], NgControlName);
  return NgControlName;
