...
var DomRenderer = (function(_super) {
  ...
  DomRenderer = __decorate([di_1.Injectable(), __param(3, di_1.Inject(dom_tokens_1.DOCUMENT_TOKEN)), __param(4, di_1.Inject(dom_tokens_1.DOM_REFLECT_PROPERTIES_AS_ATTRIBUTES)), __metadata('design:paramtypes', [event_manager_1.EventManager, shared_styles_host_1.DomSharedStylesHost, template_cloner_1.TemplateCloner, Object, Boolean])], DomRenderer);
  return DomRenderer;
})(api_1.Renderer);
