...
var ChangeDetectorJITGenerator = (function() {
  function ChangeDetectorJITGenerator(id, changeDetectionStrategy, records, directiveRecords, generateCheckNoChanges) {
    ...
    this._names = new codegen_name_util_1.CodegenNameUtil(this.records, this.directiveRecords, UTIL);
    this._logic = new codegen_logic_util_1.CodegenLogicUtil(this._names, UTIL);
