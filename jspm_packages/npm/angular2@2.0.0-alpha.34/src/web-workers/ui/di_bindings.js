...
function _injectorBindings() {
  ...
  return [di_1.bind(render_1.DOCUMENT_TOKEN).toValue(dom_adapter_1.DOM.defaultDoc()), di_1.bind(event_manager_1.EventManager).toFactory(function(ngZone) {
