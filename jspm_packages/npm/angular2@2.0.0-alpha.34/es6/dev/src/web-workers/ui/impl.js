...
import { serializeMouseEvent, serializeKeyboardEvent, serializeGenericEvent, serializeEventWithValue } from 'angular2/src/web-workers/ui/event_serializer';
/**
...
export let WebWorkerMain = class {
    ...
    _sendWorkerMessage(type, value, id) {
