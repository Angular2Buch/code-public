...
import { cloneAndQueryProtoView } from './util';
...
export let DomRenderer = class extends Renderer {
    constructor(_eventManager, _domSharedStylesHost, _templateCloner, document) {
        super();
...
DomRenderer = __decorate([
    ...
    __metadata('design:paramtypes', [EventManager, DomSharedStylesHost, TemplateCloner, Object])
], DomRenderer);
