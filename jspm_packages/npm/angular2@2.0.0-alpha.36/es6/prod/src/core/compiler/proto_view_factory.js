...
export let ProtoViewFactory = class {
    ...
    _getProtoChangeDetectors(hostComponentBinding, nestedPvsWithIndex, nestedPvVariableNames, allRenderDirectiveMetadata) {
        if (this._changeDetection.generateDetectors) {
            ...
            return changeDetectorDefs.map(changeDetectorDef => this._changeDetection.getProtoChangeDetector(changeDetectorDef.id, changeDetectorDef));
        }
        else {
 ...
 */
export function getChangeDetectorDefinitions(hostComponentMetadata, rootRenderProtoView, allRenderDirectiveMetadata, genConfig) {
    var nestedPvsWithIndex = _collectNestedProtoViews(rootRenderProtoView);
    var nestedPvVariableNames = _collectNestedProtoViewsVariableNames(nestedPvsWithIndex);
