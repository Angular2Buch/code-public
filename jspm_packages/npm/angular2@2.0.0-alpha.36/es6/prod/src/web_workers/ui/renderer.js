...
import { RenderViewRef, RenderFragmentRef, RenderProtoViewRef, Renderer } from 'angular2/src/render/api';
...
export let MessageBasedRenderer = class {
    constructor(brokerFactory, _bus, _serializer, _renderViewWithFragmentsStore, _renderer) {
        this._bus = _bus;
        ...
        broker.registerMethod("destroyView", [RenderViewRef], bind(this._renderer.destroyView, this._renderer));
...
MessageBasedRenderer = __decorate([
    Injectable(), 
    __metadata('design:paramtypes', [ServiceMessageBrokerFactory, MessageBus, Serializer, RenderViewWithFragmentsStore, Renderer])
