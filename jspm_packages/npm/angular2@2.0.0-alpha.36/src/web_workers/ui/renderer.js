...
var MessageBasedRenderer = (function() {
  function MessageBasedRenderer(brokerFactory, _bus, _serializer, _renderViewWithFragmentsStore, _renderer) {
    this._bus = _bus;
    this._serializer = _serializer;
    this._renderViewWithFragmentsStore = _renderViewWithFragmentsStore;
    this._renderer = _renderer;
    var broker = brokerFactory.createMessageBroker(messaging_api_1.RENDERER_CHANNEL);
    ...
    broker.registerMethod("destroyView", [api_1.RenderViewRef], bind_1.bind(this._renderer.destroyView, this._renderer));
  ...
  MessageBasedRenderer = __decorate([di_1.Injectable(), __metadata('design:paramtypes', [service_message_broker_1.ServiceMessageBrokerFactory, message_bus_1.MessageBus, serializer_1.Serializer, render_view_with_fragments_store_1.RenderViewWithFragmentsStore, api_1.Renderer])], MessageBasedRenderer);
