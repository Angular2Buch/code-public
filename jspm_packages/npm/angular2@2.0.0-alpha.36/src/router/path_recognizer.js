...
var PathRecognizer = (function() {
  ...
  PathRecognizer.prototype.recognize = function(beginningSegment) {
    ...
    for (var i = 0; i < this._segments.length; i += 1) {
      ...
      if (lang_1.isBlank(currentSegment)) {
        return null;
      }
    ...
    if (lang_1.isPresent(currentSegment)) {
      ...
      instruction = new instruction_1.ComponentInstruction(urlPath, urlParams, this, allParams);
      auxiliary = currentSegment.auxiliary;
    } else {
      instruction = new instruction_1.ComponentInstruction(urlPath, [], this, positionalParams);
      auxiliary = [];
    }
