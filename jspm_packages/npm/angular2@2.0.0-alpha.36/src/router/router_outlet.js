...
var RouterOutlet = (function() {
  ...
  RouterOutlet.prototype._activate = function(instruction) {
    ...
    var bindings = di_1.Injector.resolve([di_1.bind(route_data_1.ROUTE_DATA).toValue(instruction.routeData()), di_1.bind(instruction_1.RouteParams).toValue(new instruction_1.RouteParams(instruction.params)), di_1.bind(routerMod.Router).toValue(this.childRouter)]);
