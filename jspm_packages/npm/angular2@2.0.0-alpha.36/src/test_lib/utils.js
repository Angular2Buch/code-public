...
function supportsIntlApi() {
  return dom_adapter_1.DOM.getUserAgent().indexOf('Chrome/4') > -1 && dom_adapter_1.DOM.getUserAgent().indexOf('Edge') == -1;
}
exports.supportsIntlApi = supportsIntlApi;
function isFirefox() {
  return dom_adapter_1.DOM.getUserAgent().indexOf("Firefox") > -1;
}
exports.isFirefox = isFirefox;
function isAndroid() {
  var ua = dom_adapter_1.DOM.getUserAgent();
  return ua.indexOf('Mozilla/5.0') > -1 && ua.indexOf('Android ') > -1 && ua.indexOf('AppleWebKit') > -1 && ua.indexOf('Chrome') == -1;
}
exports.isAndroid = isAndroid;
function isEdge() {
  return dom_adapter_1.DOM.getUserAgent().indexOf('Edge') > -1;
}
exports.isEdge = isEdge;
function isIE() {
  return dom_adapter_1.DOM.getUserAgent().indexOf('Trident') > -1;
}
exports.isIE = isIE;
