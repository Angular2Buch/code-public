/* */ 
"format cjs";
define(["require", "exports", './Observable', './operators/combineLatest-static', './operators/concat-static', './observables/DeferObservable', './observables/EmptyObservable', './observables/ForkJoinObservable', './observables/FromObservable', './observables/ArrayObservable', './observables/FromEventObservable', './observables/FromEventPatternObservable', './observables/PromiseObservable', './observables/IntervalObservable', './operators/merge-static', './observables/InfiniteObservable', './observables/RangeObservable', './observables/ErrorObservable', './observables/TimerObservable', './operators/zip-static', './operators/buffer', './operators/bufferCount', './operators/bufferTime', './operators/bufferToggle', './operators/bufferWhen', './operators/catch', './operators/combineAll', './operators/combineLatest', './operators/concat', './operators/concatAll', './operators/concatMap', './operators/concatMapTo', './operators/count', './operators/debounce', './operators/defaultIfEmpty', './operators/delay', './operators/distinctUntilChanged', './operators/do', './operators/expand', './operators/filter', './operators/finally', './operators/first', './operators/groupBy', './operators/ignoreElements', './operators/isEmpty', './operators/last', './operators/map', './operators/mapTo', './operators/materialize', './operators/merge', './operators/mergeAll', './operators/mergeMap', './operators/mergeMapTo', './operators/multicast', './operators/observeOn', './operators/partition', './operators/publish', './operators/publishBehavior', './operators/publishReplay', './operators/reduce', './operators/repeat', './operators/retry', './operators/retryWhen', './operators/sample', './operators/sampleTime', './operators/scan', './operators/single', './operators/skip', './operators/skipUntil', './operators/startWith', './operators/subscribeOn', './operators/switch', './operators/switchMap', './operators/switchMapTo', './operators/take', './operators/takeUntil', './operators/throttle', './operators/timeout', './operators/timeoutWith', './operators/toArray', './operators/toPromise', './operators/window', './operators/windowCount', './operators/windowTime', './operators/windowToggle', './operators/windowWhen', './operators/withLatestFrom', './operators/zip', './operators/zipAll', './Subject', './Subscription', './Subscriber', './subjects/ReplaySubject', './subjects/BehaviorSubject', './observables/ConnectableObservable', './Notification', './util/EmptyError', './util/ArgumentOutOfRangeError', './schedulers/nextTick', './schedulers/immediate'], function (require, exports, Observable_1, combineLatest_static_1, concat_static_1, DeferObservable_1, EmptyObservable_1, ForkJoinObservable_1, FromObservable_1, ArrayObservable_1, FromEventObservable_1, FromEventPatternObservable_1, PromiseObservable_1, IntervalObservable_1, merge_static_1, InfiniteObservable_1, RangeObservable_1, ErrorObservable_1, TimerObservable_1, zip_static_1, buffer_1, bufferCount_1, bufferTime_1, bufferToggle_1, bufferWhen_1, catch_1, combineAll_1, combineLatest_1, concat_1, concatAll_1, concatMap_1, concatMapTo_1, count_1, debounce_1, defaultIfEmpty_1, delay_1, distinctUntilChanged_1, do_1, expand_1, filter_1, finally_1, first_1, groupBy_1, ignoreElements_1, isEmpty_1, last_1, map_1, mapTo_1, materialize_1, merge_1, mergeAll_1, mergeMap_1, mergeMapTo_1, multicast_1, observeOn_1, partition_1, publish_1, publishBehavior_1, publishReplay_1, reduce_1, repeat_1, retry_1, retryWhen_1, sample_1, sampleTime_1, scan_1, single_1, skip_1, skipUntil_1, startWith_1, subscribeOn_1, switch_1, switchMap_1, switchMapTo_1, take_1, takeUntil_1, throttle_1, timeout_1, timeoutWith_1, toArray_1, toPromise_1, window_1, windowCount_1, windowTime_1, windowToggle_1, windowWhen_1, withLatestFrom_1, zip_1, zipAll_1, Subject_1, Subscription_1, Subscriber_1, ReplaySubject_1, BehaviorSubject_1, ConnectableObservable_1, Notification_1, EmptyError_1, ArgumentOutOfRangeError_1, nextTick_1, immediate_1) {
