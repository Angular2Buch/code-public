...
define(["require", "exports", '../util/tryCatch', '../util/errorObject', '../OuterSubscriber', '../util/subscribeToResult'], function (require, exports, tryCatch_1, errorObject_1, OuterSubscriber_1, subscribeToResult_1) {
    ...
    var MergeMapToSubscriber = (function (_super) {
        ...
        MergeMapToSubscriber.prototype.notifyNext = function (innerValue, outerValue, innerIndex, outerIndex) {
            var _a = this, resultSelector = _a.resultSelector, destination = _a.destination;
            if (resultSelector) {
                var result = tryCatch_1.default(resultSelector)(innerValue, outerValue, innerIndex, outerIndex);
