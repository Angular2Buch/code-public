    ...
    var WindowTimeSubscriber = (function (_super) {
        ...
        function WindowTimeSubscriber(destination, windowTimeSpan, windowCreationInterval, scheduler) {
            ...
            if (windowCreationInterval !== null && windowCreationInterval >= 0) {
                ...
                this.add(scheduler.schedule(dispatchWindowClose, windowTimeSpan, { subscriber: this, window: window_1, context: null }));
                ...
                this.add(scheduler.schedule(dispatchWindowTimeSpanOnly, windowTimeSpan, { subscriber: this, window: window_2, windowTimeSpan: windowTimeSpan }));
            }
        }
